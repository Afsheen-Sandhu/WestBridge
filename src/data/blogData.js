export const blogPosts = [
    {
        id: 1,
        slug: "strategic-discovery-web-development",
        title: "The Power of Strategic Discovery in Web Development",
        excerpt: "Why understanding your audience and brand voice is the most critical step before writing a single line of code.",
        category: "Strategy",
        ...
        content: `
            ...
            <ul>
                ...
                <li><strong>Technical Feasibility:</strong> Mapping out the architecture early to avoid costly pivots later.</li>
            </ul>
    ...
    {
        id: 2,
        slug: "mobile-first-design-requirement",
        title: "Mobile-First Design: A Requirement, Not an Option",
        excerpt: "Exploring the technical and psychological reasons why mobile optimization is now the foundation of every high-performing website.",
        category: "Design",
        author: "Junaid Khan",
        date: "March 8, 2026",
        image: "/mobile.png",
        content: `
            ...
            <ul>
                <li><strong>Speed:</strong> Mobile users expect near-instant load times. Small performance gains lead to huge conversion lifts.</li>
                <li><strong>Accessibility:</strong> Designing for thumbs and small viewports makes for a better experience for everyone.</li>
    ...
    {
        id: 3,
        slug: "maximizing-roi-conversion-strategy",
        title: "Maximizing ROI Through Data-Driven Conversion Strategy",
        excerpt: "How to combine high-end aesthetics with strategic user behavior data to turn casual visitors into loyal customers.",
        category: "Marketing",
        author: "Afsheen Sandhu",
        date: "March 5, 2026",
    ...
    {
        id: 4,
        slug: "art-of-pixel-perfect-development",
        title: "The Art of Pixel-Perfect Development",
        excerpt: "A deep dive into the precision engineering required to translate high-end designs into fast, accessible digital products.",
        ...
        content: `
            ...
            <ul>
                ...
                <li><strong>Tailwind CSS/Vanilla CSS:</strong> For granular control over every visual property.</li>
    ...
    {
        id: 5,
        slug: "scaling-cms-best-practices",
        title: "Scaling Effortlessly: CMS Best Practices for Growth",
        excerpt: "How a robust, intuitive CMS allows your marketing team to launch content at the speed of business.",
        category: "CMS",
        author: "Junaid Khan",
        date: "Feb 28, 2026",
        image: "/cms.png",
        content: `
            ...
            <ul>
                ...
                <li><strong>Secure:</strong> Protecting your data and user information.</li>
    ...
    },
    {
        ...
        title: "Future-Proofing Your Digital Infrastructure",
        excerpt: "Strategies for building scalable architectures that adapt seamlessly as your business and technology evolve.",
        category: "Tech",
        author: "Afsheen Sandhu",
        date: "Feb 25, 2026",
