        ...
        <div className="w-full transition-colors duration-400" style={{ background: theme === 'dark' ? '#000' : '#fff' }}>
            ...
            >
                <div className="w-full max-w-[1000px] px-8 flex flex-col items-center text-center">
                    ...
                    >
                        Our Latest <br />
                        <span className="font-accent italic font-normal opacity-90">Insights</span>
                    </h1>
                    ...
                    >
                        Stay updated with our thoughts on design, tech trends, and the future of digital innovation.
                    </p>

                    <div className="mt-20 w-full flex justify-center py-20 border-t border-dashed border-white/10">
                        <span className="text-sm uppercase tracking-[0.4em] opacity-40">Blogs and articles coming soon</span>
                    </div>
                </div>
            </section>
        </div>
